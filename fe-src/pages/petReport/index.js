...
exports.MascotasReportadas = void 0;
...
class MascotasReportadas extends HTMLElement {
    ...
    async loadMascotasReportadas() {
        try {
            const reporteResponse = await state_1.state.mascotasReportadas();
            if (reporteResponse && reporteResponse.pets.length > 0) {
                ...
                reporteResponse.pets.forEach(pet => {
                    ...
                    deleteButton.addEventListener("click", async () => {
                        ...
                        if (confirmDelete) {
                            await state_1.state.eliminarMascota(pet.id);
                            location.reload();
                        }
                    });
...
exports.MascotasReportadas = MascotasReportadas;
